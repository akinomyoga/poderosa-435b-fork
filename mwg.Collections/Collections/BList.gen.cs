...
namespace mwg.Collections{
    ...
    where T:BListExElement
  {
    ...
    private abstract class Node{
      ...
      internal virtual void set_list(BListEx<T> list){
        this.list=list;
      }
    ...
    private class Node1:Node{
      ...
      internal override void set_list(BListEx<T> list){
        if(this.list==list)return;
        this.list=list;
        for(int i=0,iN=this.data.Count;i<iN;i++)
          this.data[i].set_list(list);
    ...
    where T:BListE2Element<T>
  {
    ...
    private abstract class Node{
      ...
      internal virtual void set_list(BListE2<T> list){
        this.list=list;
      }
    ...
    private class Node1:Node{
      ...
      internal override void set_list(BListE2<T> list){
        if(this.list==list)return;
        this.list=list;
        for(int i=0,iN=this.data.Count;i<iN;i++)
          this.data[i].set_list(list);
