 ...
 *
 * $Id: StartCommands.cs,v 1.4 2011/08/03 17:37:53 kzmi Exp $
 */
using System;
...
namespace Poderosa.Sessions {
    ...
    internal class StartCommand : ITerminalSessionStartCommand {
        ...
        public CommandResult InternalExecute(ICommandTarget target, params IAdaptable[] args) {
            if(args.Length!=2) StartCommandArgError();
            ...
            if((param==null && connection==null) || settings==null) StartCommandArgError();
        ...
        private static IPoderosaView ToPoderosaView(ICommandTarget target) {
            ...
            if(rv!=null) view = rv.AssureViewClass(typeof(TerminalView));
            return view;
        }
