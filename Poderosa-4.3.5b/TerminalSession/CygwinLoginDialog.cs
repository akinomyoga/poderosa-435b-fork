 ...
 *
 * $Id: CygwinLoginDialog.cs,v 1.9 2011/08/03 16:07:50 kzmi Exp $
 */
using System;
...
namespace Poderosa.Sessions
{
	...
	internal class LocalShellLoginDialog : LoginDialogBase
	{
		...
		public void ApplyParam() {
			...
			if(parameter==null) parameter = TerminalSessionsPlugin.Instance.ProtocolService.CreateDefaultCygwinParameter();
			if(settings==null) settings = CygwinPlugin.Instance.CreateDefaultCygwinTerminalSettings();
