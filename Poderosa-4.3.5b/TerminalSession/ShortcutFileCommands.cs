 ...
 *
 * $Id: ShortcutFileCommands.cs,v 1.5 2011/06/19 09:26:48 kzmi Exp $
 */
using System;
...
namespace Poderosa.Sessions {
    ...
    internal class ShortcutFileCommands {
        ...
        public static CommandResult OpenShortcutFile(ICommandTarget target, string filename) {
            ...
            if(window==null) window = (IPoderosaMainWindow)CommandTargetUtil.AsViewOrLastActivatedView(target).ParentForm.GetAdapter(typeof(IPoderosaMainWindow));
        ...
        private static CommandResult SaveShortcutFile(ICommandTarget target) {
            ...
            if(t==null) return CommandResult.Failed;
