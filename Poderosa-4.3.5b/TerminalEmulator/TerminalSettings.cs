...
namespace Poderosa.Terminal
{
	...
	public class TerminalSettings : ITerminalSettings, IShellSchemeDynamicChangeListener {
		...
		public RenderProfile RenderProfile {
			...
			set {
				EnsureUpdating();
				if(_renderProfile==value)return;
				if(_renderProfile!=null) _renderProfile.Dispose();
				_renderProfile = value;
				if(this.ChangeRenderProfile!=null) this.ChangeRenderProfile(value);
			}
		}
