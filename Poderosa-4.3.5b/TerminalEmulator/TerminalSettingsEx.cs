...
namespace Poderosa.Terminal
{
    ...
    public interface IMultiLogSettings : ILogSettings, IEnumerable<ILogSettings> {
        void Reset(ILogSettings log); //これ単独にする
    ...
    public interface ITerminalSettings : IListenerRegistration<ITerminalSettingsChangeListener>, IAdaptable {
        ...
        /// </en>
        /// </remarks>
        IShellScheme ShellScheme { get; set; }
        /// <summary>
        /// <ja>
        ...
        /// </en>
        /// </remarks>
        bool EnabledCharTriggerIntelliSense { get; set; }
        ...
        /// </en>
        /// </remarks>
        RenderProfile RenderProfile { get; set; }
        ...
        /// </en>
        /// </summary>
        bool UsingDefaultRenderProfile { get; }
