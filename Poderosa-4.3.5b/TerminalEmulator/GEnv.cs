 ...
 *
 * $Id: GEnv.cs,v 1.1 2010/11/19 15:41:11 kzmi Exp $
 */
using System;
...
namespace Poderosa
{
	internal class GEnv {
		...
		private static void ReloadStringResource() {
            if(_stringResource!=null) EnumDescAttribute.RemoveResourceTable(typeof(GEnv).Assembly, _stringResource);
		...
		public static RenderProfile DefaultRenderProfile {
			...
			set {
				if(_defaultRenderProfile==value)return;
				if(_defaultRenderProfile!=null)
					_defaultRenderProfile.Dispose();
