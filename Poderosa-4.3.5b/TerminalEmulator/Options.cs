 ...
 *
 * $Id: Options.cs,v 1.6 2011/04/24 04:07:00 kzmi Exp $
 */
using System;
using System.IO;
...
namespace Poderosa.Terminal
{
    ...
    internal class TerminalOptions : SnapshotAwarePreferenceBase, ITerminalEmulatorOptions {
        ...
        public TerminalOptions(IPreferenceFolder folder) : base(folder) {
        }
        ...
        public Keys IntelliSenseKey {
            get {
                if(_parseKeyRequired) ParseKeys();
    ...
    /// </summary>
    /// <exclude/>
	[EnumDesc(typeof(MouseButtonAction))]
	public enum MouseButtonAction {
        [EnumValue(Description="Enum.MouseButtonAction.None")] None,
        [EnumValue(Description="Enum.MouseButtonAction.ContextMenu")] ContextMenu,
		[EnumValue(Description="Enum.MouseButtonAction.Paste")] Paste
	}
