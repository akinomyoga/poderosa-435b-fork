 ...
 *
 * $Id: TerminalToolBar.cs,v 1.2 2011/06/19 08:02:15 kzmi Exp $
 */
using System;
...
namespace Poderosa.Terminal {
    internal class TerminalToolBar : IToolBarComponent, IPositionDesignation, IActiveDocumentChangeListener {
        ...
        private class NewLineChangeHandler : ToolBarComboBoxImpl {
            public override string[] Items {
                get {
                    return EnumDescAttribute.For(typeof(NewLine)).DescriptionCollection();
                }
            }
        ...
        private class EncodingChangeHandler : ToolBarComboBoxImpl {
            public override string[] Items {
                get {
                    return EnumDescAttribute.For(typeof(EncodingType)).DescriptionCollection();
                }
            }
            public override int Width {
                get {
            ...
            public override void OnChange(ICommandTarget target, int selectedIndex) {
                ...
                ITerminalSettings ts = session.TerminalSettings;
                ts.BeginUpdate();
                ts.Encoding = (EncodingType)selectedIndex;
                ts.EndUpdate();
            }
        }
    ...
    internal class TerminalToolBarInstance : ITerminalSettingsChangeListener {
        ...
        public void Attach(ITerminalSettings ts) {
            if(_terminalSettings!=null) _terminalSettings.RemoveListener(this);
