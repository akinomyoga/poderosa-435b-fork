 ...
 *
 * $Id: IntelliSenseEx.cs,v 1.1 2010/11/19 15:41:11 kzmi Exp $
 */
using System;
...
namespace Poderosa.Terminal {
    ...
    public interface IShellSchemeCollection : IAdaptable {
        ...
        IEnumerable<IShellScheme> Items { get; }
    ...
    public interface IShellScheme : IAdaptable {
        bool IsGeneric { get; }
        string Name { get; set; }
        string PromptExpression { get; set; }
        char BackSpaceChar { get; set; }

        string[] ParseCommandInput(string src);
        string ParseFirstCommand(string src, out bool is_partial);

        bool IsDelimiter(char ch);
        char DefaultDelimiter { get; }
        IIntelliSenseItemCollection CommandHistory { get; }
    ...
    public interface IIntelliSenseItemCollection : IAdaptable {
        ...
        IEnumerable<IIntelliSenseItem> Items { get; }
        int Count { get; }
    }
