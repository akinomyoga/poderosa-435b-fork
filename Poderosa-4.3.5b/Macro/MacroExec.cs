 ...
 *
 * $Id: MacroExec.cs,v 1.8 2011/06/27 22:58:43 kzmi Exp $
 */
using System;
...
namespace Poderosa.MacroInternal
{
	internal class MacroUtil
	{
        ...
        private static ITerminalSettings CreateTerminalSettings(TerminalParam param) {
            ...
            ts.BeginUpdate();
            ts.RenderProfile = (RenderProfile)param.RenderProfile.Clone();
					...
					if (_traceWindow != null) {
						if (_traceWindow.Visible)
							...
							_traceWindow.BeginInvoke(
								(System.Windows.Forms.MethodInvoker)delegate() { traceWindow.Dispose(); });
						}
						_traceWindow = null;
					}
				}
