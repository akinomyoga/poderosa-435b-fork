 ...
 *
 * $Id: TerminalOptionPanel.cs,v 1.3 2010/12/29 12:51:20 kzmi Exp $
 */
using System;
...
namespace Poderosa.Forms
{
	internal class TerminalOptionPanel : UserControl {
		...
		public void InitUI(ITerminalEmulatorOptions options) {
            ...
            _charDecodeErrorBehaviorBox.SelectedIndex = (int)options.CharDecodeErrorBehavior;
		...
		public bool Commit(ITerminalEmulatorOptions options) {
			...
			try {
				...
				options.CharDecodeErrorBehavior = (WarningOption)_charDecodeErrorBehaviorBox.SelectedIndex;
				options.DisconnectNotification = (WarningOption)_disconnectNotification.SelectedIndex;
