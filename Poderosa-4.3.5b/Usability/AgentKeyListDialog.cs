 ...
 *
 * $Id: AgentKeyListDialog.cs,v 1.1 2010/11/19 15:41:31 kzmi Exp $
 */
using System;
...
namespace Poderosa.Forms {
    public partial class AgentKeyListDialog : Form {
        ...
        private void OnListDoubleClick(object sender, System.EventArgs e) {
            ...
            if(key.Status==PrivateKeyStatus.OK) return; //Šù‚ÉŠm”FÏ‚Ý
        ...
        private void OnOK(object sender, System.EventArgs e) {
            ...
            foreach(ListViewItem li in _list.Items) keys.Add((AgentPrivateKey)li.Tag);
