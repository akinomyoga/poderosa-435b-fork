 ...
 *
 * $Id: FontDialog.cs,v 1.3 2010/11/24 16:04:10 kzmi Exp $
 */
using System;
...
namespace Poderosa.Forms {
	...
	internal class GFontDialog : System.Windows.Forms.Form {
		...
		public void SetFont(bool cleartype, bool enable_bold, bool force_bold, Font ascii, Font cjk) {
			...
			if(_cjkFontList.SelectedIndex==-1) _cjkFontList.SelectedIndex = _cjkFontList.FindStringExact("ＭＳ ゴシック");
		...
		private void OnCJKFontChange(object sender, EventArgs args) {
			if(_ignoreEvent || _cjkFontList.SelectedIndex==-1) return;
