 ...
 *
 * $Id: TerminalUICommands.cs,v 1.1 2010/11/19 15:41:31 kzmi Exp $
 */
using System;
...
namespace Poderosa.Usability {
    internal class TerminalUICommand : GeneralCommandImpl {
        ...
        private static CommandResult CmdEditRenderProfile(ICommandTarget target) {
            ...
            if(s==null) return CommandResult.Ignored;
    ...
    internal class StandardTerminalUIMenuItem : PoderosaMenuItemImpl {
        ...
        public StandardTerminalUIMenuItem(string textID, string commandID) : base(commandID, TerminalUIPlugin.Instance.Strings, textID) {
        }
