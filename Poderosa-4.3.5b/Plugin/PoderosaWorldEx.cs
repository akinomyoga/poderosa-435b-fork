 ...
 *
 * $Id: PoderosaWorldEx.cs,v 1.2 2010/11/27 13:03:19 kzmi Exp $
 */
using System;
...
namespace Poderosa.Plugins
{
    ...
    public interface IPoderosaApplication : IAdaptable {
        ...
        void Shutdown();
        string InitialOpenFile { get; } //無指定はnull
    }
    ...
    public interface IStartupContextSupplier : IAdaptable {
        ...
        string PreferenceFileName { get; } //preferenceは常にファイルから読むとは限らない。nullのこともある
    }
    ...
    public interface IPoderosaCulture {
        ...
        bool IsSimplifiedChineseOS { get; }
        bool IsTraditionalChineseOS { get; }
        bool IsKoreanOS { get; }
    }
