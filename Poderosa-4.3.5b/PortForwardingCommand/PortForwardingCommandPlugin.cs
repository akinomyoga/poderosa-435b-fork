 ...
 *
 * $Id: PortForwardingCommandPlugin.cs,v 1.1 2010/11/19 15:41:03 kzmi Exp $
 */
using System;
...
#if MONOLITHIC
                string path = Path.Combine(app.HomeDirectory, "portforwarding.exe");
#else
                string path = Path.Combine(app.HomeDirectory, "PortForwarding\\portforwarding.exe");
#endif
                Process.Start(path);
