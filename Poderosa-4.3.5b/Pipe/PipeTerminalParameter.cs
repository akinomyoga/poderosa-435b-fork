 ...
 *
 * $Id: PipeTerminalParameter.cs,v 1.1 2011/08/04 15:28:58 kzmi Exp $
 */
using System;
...
namespace Poderosa.Pipe {
    ...
    internal class PipeTerminalParameter : ITerminalParameter, IAutoExecMacroParameter {
        ...
        public string InputPipePath {
            get { return _inputPipePath; }
            set { _inputPipePath = value; }
        }
        ...
        public string OutputPipePath {
            get { return _outputPipePath; }
            set { _outputPipePath = value; }
        }
