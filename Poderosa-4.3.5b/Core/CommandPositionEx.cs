 ...
 *
 * $Id: CommandPositionEx.cs,v 1.1 2010/11/19 15:40:39 kzmi Exp $
 */
using System;
...
namespace Poderosa.Commands
{
    ...
    public interface IPositionDesignation : IAdaptable {
        ...
        /// </en>
        /// </remarks>
        IAdaptable DesignationTarget { get; } //can be null
        /// <summary>
        /// <ja>
            ...
            public int CompareTo(Entry other) {
                if(this.IsIndependent) {
                    ...
                    if(other.IsIndependent)
                        ...
                        if(r==0) r = this.index - other.index; //依存先で判定できない場合は仕方ない
                        return r;
                    }
                }
            }
