 ...
 *
 * $Id: SelectionEx.cs,v 1.1 2010/11/19 15:40:39 kzmi Exp $
 */
using System;
...
namespace Poderosa.View {
  ...
  public interface ISelectionService {
    ...
    /// </en>
    /// </remarks>
    ISelection ActiveSelection { get; } //ActiveViewのSelectionと同義
    /// <summary>
    /// <ja>
  ...
  public enum TextFormatOption {
    ...
    AsLook    =0x1,
    /// <summary>
    /// <ja>行末の空白文字の連続を削除します。</ja>
    /// <en>Returns text after trimming spaces on the end of each line.</en>
    /// </summary>
    TrimEol   =0x2,
    /// <summary>
    /// <ja>矩形選択を実行します。</ja>
    /// <en>Selects text in the rectangle region.</en>
    /// </summary>
    Rectangle =0x4
  }
