 ...
 *
 * $Id: ToolBar.cs,v 1.1 2010/11/19 15:40:39 kzmi Exp $
 */
using System;
...
namespace Poderosa.Forms {
    internal class PoderosaToolStripContainer : ToolStripContainer, IToolBar {
        ...
        private void DefineCommandButton(IToolBarComponent comp, IToolBarCommandButton element) {
            ...
            if(gc!=null && gc.Description.Length>0)
        ...
        private class ButtonTag : ControlTagBase {
            ...
            public ButtonTag(ICommandTarget target, IToolBarComponent owner, IPoderosaCommand command) : base(owner) {
                _target = target;
